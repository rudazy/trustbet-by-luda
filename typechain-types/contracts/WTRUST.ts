...
export interface WTRUSTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DOMAIN_SEPARATOR"
      | "allowance"
...
export interface WTRUST extends BaseContract {
  connect(runner?: ContractRunner | null): WTRUST;
  waitForDeployment(): Promise<this>;

  interface: WTRUSTInterface;
